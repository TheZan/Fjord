...
Phase 12 (`P12-MERGE-01`–`05`) planned three new commands; all three have
shipped and moved to the table above: `get_conflicts` and `resolve_conflict`
with `P12-MERGE-03`, `update_branch_fast_forward` with `P12-MERGE-04`.
