...
| Phase 8 — Daily-driver essentials | 🚧 underway: destructive-preflight foundation `P8-00`, patch model/generation `P8-01`, and partial stage/unstage mutations `P8-02`/`P8-03` complete; discard patch application, UI, amend, push, and diff tasks remain ([`specs/working-tree-and-diff.md`](specs/working-tree-and-diff.md)) |
