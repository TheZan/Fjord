...
| Phase 8 — Daily-driver essentials | ⚠️ partial-patch safety scope, amend, commit-and-push, authoritative force-with-lease, upstream management, and unified/split diff modes are complete (`P8-00`–`P8-11`, `P8-FIX-07`). Later diff capabilities remain open ([`specs/working-tree-and-diff.md`](specs/working-tree-and-diff.md)). |
