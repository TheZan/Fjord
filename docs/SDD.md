...
| Phase 10 — Daily-driver integration, advanced workflows & workspace | 🚧 in progress: local merge initiation is implemented through `P10-MERGE-01`, and the Working Changes context-menu foundation is implemented through `P10-WC-01`. Remote-tracking/squash merge and the independent working-file extensions `P10-WC-02`–`P10-WC-06` remain designed in [`specs/branch-merge.md`](specs/branch-merge.md) and [`specs/working-tree-and-diff.md`](specs/working-tree-and-diff.md) §6; later workspace work remains designed in [`specs/workspace-workflows.md`](specs/workspace-workflows.md). See [`tasks.md`](tasks.md) §"Phase 10 execution order". |
...
- [`specs/`](specs/) — per-subsystem contracts. One spec owns each contract; other documents cross-reference it rather than restating it:
  ...
  - Implemented through `P10-MERGE-01`: [`branch-merge.md`](specs/branch-merge.md); its remote-tracking and squash extensions (`P10-MERGE-02`, `P10-MERGE-03`) remain designed, and its integration preflight is the owner rebase reuses. Implemented through `P10-WC-01`: [`working-tree-and-diff.md`](specs/working-tree-and-diff.md) §6 — the single owner of the Working Changes file context menu; its independent extensions `P10-WC-02`–`P10-WC-06` remain designed. Designed: [`workspace-workflows.md`](specs/workspace-workflows.md) (Phase 10) and [`release-hardening.md`](specs/release-hardening.md) (Phase 11).
