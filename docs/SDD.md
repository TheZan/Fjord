...
| Phase 9 — Safety & recovery | 🚧 P9-01–P9-09 implemented; P9-10 regression hardening remains ([`specs/repository-safety.md`](specs/repository-safety.md)) |
