...
| Phase 10 — Daily-driver integration, advanced workflows & workspace | 🚧 in progress: local merge initiation is implemented through `P10-MERGE-01`; remote-tracking and squash merge remain designed in [`specs/branch-merge.md`](specs/branch-merge.md). The remaining daily-driver gap is the Working Changes file context menu (`P10-WC-01`–`P10-WC-06`, [`specs/working-tree-and-diff.md`](specs/working-tree-and-diff.md) §6); later workspace work remains designed in [`specs/workspace-workflows.md`](specs/workspace-workflows.md). See [`tasks.md`](tasks.md) §"Phase 10 execution order". |
...
- [`specs/`](specs/) — per-subsystem contracts. One spec owns each contract; other documents cross-reference it rather than restating it:
  ...
  - Implemented through `P10-MERGE-01`: [`branch-merge.md`](specs/branch-merge.md); its remote-tracking and squash extensions (`P10-MERGE-02`, `P10-MERGE-03`) remain designed, and its integration preflight is the owner rebase reuses. Designed: [`working-tree-and-diff.md`](specs/working-tree-and-diff.md) §6 (Phase 10, `P10-WC-01`–`P10-WC-06`) — the single owner of the Working Changes file context menu; [`workspace-workflows.md`](specs/workspace-workflows.md) (Phase 10) and [`release-hardening.md`](specs/release-hardening.md) (Phase 11).
