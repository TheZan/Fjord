...
| Phase 8 — Daily-driver essentials | ⚠️ partial-patch safety scope complete and independently verified (`P8-00`–`P8-06`, `P8-FIX-07`); amend and commit-and-push are complete (`P8-07`–`P8-08`). Force-with-lease, upstream management, and later diff capabilities remain open ([`specs/working-tree-and-diff.md`](specs/working-tree-and-diff.md)). |
