...
| Phase 12 — Merge completeness & conflict resolution | 🚧 in progress: `--no-ff` with an editable merge message (`P12-MERGE-01`), wider sources/unrelated histories (`P12-MERGE-02`) and **Update `{{branch}}` from `{{source}}`**, a fast-forward of a branch that is not checked out (`P12-MERGE-04`, [`specs/branch-merge.md`](specs/branch-merge.md) §10.3) shipped; `P12-MERGE-03` and `P12-MERGE-05` designed ([`specs/branch-merge.md`](specs/branch-merge.md) §10, [`specs/conflict-resolution.md`](specs/conflict-resolution.md)) |
