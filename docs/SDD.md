...
| Phase 10 — Daily-driver integration, advanced workflows & workspace | 🚧 in progress: branch merge (`P10-MERGE-01`–`03`), Working Changes file actions (`P10-WC-01`–`06`), multi-selection and all batch actions (`P10-WC-MULTI-01`–`03`), stash management (`P10-STASH-01`–`06`), backend remote CRUD (`P10-06`), and Workspace Intelligence (`P10-08`–`10`: backend health, expected branch, and shared persisted filters) are complete. Worktrees, basic rebase, the remaining Remotes UI/picker (`P10-07`), and interactive rebase remain open. See [`tasks.md`](tasks.md) §"Phase 10 execution order". |
