...
| Phase 8 — Daily-driver essentials | ⚠️ partial-patch safety scope, amend, commit-and-push, authoritative force-with-lease, upstream management, unified/split diff modes, and visible-window worker highlighting are complete (`P8-00`–`P8-12`, `P8-FIX-07`). Later diff capabilities remain open ([`specs/working-tree-and-diff.md`](specs/working-tree-and-diff.md)). |
...
- [`specs/`](specs/) — per-subsystem contracts:
  ...
  - Implemented through visible-window worker diff highlighting: [`working-tree-and-diff.md`](specs/working-tree-and-diff.md) (`P8-00`–`P8-12`, `P8-FIX-07`); its later Phase 8 capabilities remain designed. [`repository-safety.md`](specs/repository-safety.md) implements that Phase 8 foundation and designs its Phase 9 extensions; [`workspace-workflows.md`](specs/workspace-workflows.md) (Phase 10) and [`release-hardening.md`](specs/release-hardening.md) (Phase 11) remain designed.
