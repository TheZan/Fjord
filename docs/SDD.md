...
| Phase 8 — Daily-driver essentials | ⚠️ partial-patch safety scope, amend, commit-and-push, authoritative force-with-lease, upstream management, unified/split diff modes, visible-window worker highlighting, and backend whitespace modes are complete (`P8-00`–`P8-13`, `P8-FIX-07`). Word diff and huge-diff UX remain open ([`specs/working-tree-and-diff.md`](specs/working-tree-and-diff.md)). |
...
- [`specs/`](specs/) — per-subsystem contracts:
  ...
  - Implemented through backend whitespace diff modes: [`working-tree-and-diff.md`](specs/working-tree-and-diff.md) (`P8-00`–`P8-13`, `P8-FIX-07`); word diff and huge-diff UX remain designed. [`repository-safety.md`](specs/repository-safety.md) implements that Phase 8 foundation and designs its Phase 9 extensions; [`workspace-workflows.md`](specs/workspace-workflows.md) (Phase 10) and [`release-hardening.md`](specs/release-hardening.md) (Phase 11) remain designed.
