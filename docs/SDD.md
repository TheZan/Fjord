...
| Phase 12 — Merge completeness & conflict resolution | 🚧 in progress: `--no-ff` with an editable merge message (`P12-MERGE-01`), wider sources/unrelated histories (`P12-MERGE-02`), in-app conflict resolution from the live index (`P12-MERGE-03`, [`specs/conflict-resolution.md`](specs/conflict-resolution.md)) and the `-X ours`/`-X theirs` strategy option worded by ref behind the merge dialog's Advanced disclosure (`P12-MERGE-05`, [`specs/branch-merge.md`](specs/branch-merge.md) §10.4) shipped; `P12-MERGE-04` designed ([`specs/branch-merge.md`](specs/branch-merge.md) §10.3) |
