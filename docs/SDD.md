...
| Phase 9 — Safety & recovery | 🚧 P9-01 implemented; remaining work designed ([`specs/repository-safety.md`](specs/repository-safety.md)) |
...
- [`specs/`](specs/) — per-subsystem contracts:
  ...
  - Implemented: [`working-tree-and-diff.md`](specs/working-tree-and-diff.md) (`P8-00`–`P8-15`, `P8-FIX-07`). [`repository-safety.md`](specs/repository-safety.md) implements that Phase 8 foundation plus the P9-01 local operation-state detector and designs the remaining Phase 9 extensions; [`workspace-workflows.md`](specs/workspace-workflows.md) (Phase 10) and [`release-hardening.md`](specs/release-hardening.md) (Phase 11) remain designed.
