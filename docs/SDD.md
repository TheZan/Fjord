...
| Phase 10 — Daily-driver integration, advanced workflows & workspace | 🚧 in progress: branch merge (`P10-MERGE-01`–`03`), Working Changes file actions (`P10-WC-01`–`06`), the multi-selection model (`P10-WC-MULTI-01`), stable stash identity (`P10-STASH-01`), and unified exact-scope stash creation (`P10-STASH-02`) are complete. Stash presentation/actions (`P10-STASH-03`–`06`) and the remaining Working Changes batch actions (`P10-WC-MULTI-02`–`03`) remain designed; later workspace work remains designed in [`specs/workspace-workflows.md`](specs/workspace-workflows.md). See [`tasks.md`](tasks.md) §"Phase 10 execution order". |
