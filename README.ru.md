...
и задать upstream** и явная отправка текущей ветки в несколько выбранных remotes
без изменения upstream, а также управление незавершёнными операциями, preflight
опасных действий и Recovery Center на основе reflog. Чувствительные сетевые
операции выполняет установленный системный Git.
