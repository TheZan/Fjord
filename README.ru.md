...
- [x] Сетевые операции через установленный Git пользователя (credential helpers, GCM, SSH agent)
- [ ] Первый публичный релиз
- [ ] Фундамент производительности: измеримые SLO, тяжёлые fixtures, долгоживущий runtime репозитория
- [ ] Переработка оболочки: keyboard-first навигация, сохраняемый layout, меньше chrome
- [ ] Ежедневная работа: hunk staging, amend, безопасный force push, богатый diff
- [ ] Безопасность и восстановление: состояния операций, информативные preflight, восстановление через reflog
- [ ] Workspace-сценарии: worktrees, rebase, remotes, health рабочего пространства
